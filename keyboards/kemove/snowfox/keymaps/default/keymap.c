...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_FN_LAYER] = KEYMAP( /* Base */
    ...
    KC_TRNS, SNOWFOX_BLE_DISCOVER, SNOWFOX_BLE_CONN, SNOWFOX_BLE_DISCONN, KC_TRNS, KC_TRNS, KC_TRNS, KC_PSCR, KC_SLCK, KC_PAUS, SNOWFOX_LED_BDN, SNOWFOX_LED_BUP, SNOWFOX_LED_OFF,  SNOWFOX_LED_ON,
    KC_CAPS, KC_MPLY, KC_MPRV, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, KC_INS, KC_HOME, KC_PGUP, KC_TRNS, KC_TRNS,         KC_TRNS,
