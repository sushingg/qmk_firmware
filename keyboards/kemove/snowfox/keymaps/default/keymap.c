...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_FN_LAYER] = KEYMAP( /* Base */
    ...
    KC_TRNS, SNOWFOX_BLE_DISCOVER, SNOWFOX_BLE_CONN, SNOWFOX_BLE_DISCONN, KC_TRNS, KC_TRNS, KC_TRNS, KC_PSCR, KC_SLCK, KC_PAUS, KC_TRNS, KC_TRNS, SNOWFOX_LED_OFF,  SNOWFOX_LED_ON,
